...
if ($updatedCapacity < 0 ) {
	...
	$url = 'http://localhost/tms/tms/email.php?message=' . urlencode("Your reservation for the $eventseat seat has been confirmed. Please present this confirmation at the entrance, and we hope you have a wonderful time enjoying the show!") . '&sub=' . urlencode("Booking Confirmation!!") . '&email=' . urlencode($useremail);
